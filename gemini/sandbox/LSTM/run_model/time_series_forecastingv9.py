...
def preprocess_data(df, seq_length=5, window_size=3):
    ...
    features = df[['price', 'amount', 'price_ma', 'price_volatility', 'price_momentum']].values
...
def build_model(input_shape):
    ...
    lstm1 = LSTM(200, return_sequences=True, dropout=0.1, recurrent_dropout=0.1, kernel_regularizer=tf.keras.regularizers.l2(0.01))(inputs)
    lstm2 = LSTM(200, return_sequences=True, dropout=0.1, recurrent_dropout=0.1, kernel_regularizer=tf.keras.regularizers.l2(0.01))(lstm1)
    attention = Attention()([lstm2, lstm2])
    dense1 = Dense(150, kernel_regularizer=tf.keras.regularizers.l2(0.01))(attention)
    dense2 = Dense(100, kernel_regularizer=tf.keras.regularizers.l2(0.01))(dense1)
    dense3 = Dense(50, kernel_regularizer=tf.keras.regularizers.l2(0.01))(dense2)
...
def train_model(model, train_dataset, val_dataset, epochs=40, steps_per_epoch=None):
