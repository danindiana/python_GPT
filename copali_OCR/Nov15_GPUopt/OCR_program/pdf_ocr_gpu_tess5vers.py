...
os.environ['TESSDATA_PREFIX'] = '/usr/share/tesseract-ocr/5.3.0'

# Verify TESSDATA_PREFIX and tessdata directory
...
def extract_text_without_ocr(pdf_path):
    ...
    text = ""
    try:
        with fitz.Document(pdf_path) as doc:  # Use fitz.Document instead of fitz.open
            for page in doc:
                text += f"\n--- Page {page.number + 1} ---\n"
