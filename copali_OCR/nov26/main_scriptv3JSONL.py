...
for pdf_file in pdf_files:
    ...
    try:
        ...
        # Generate output file path based on selected format
        output_file_base = os.path.join(output_dir, f"{os.path.splitext(pdf_file)[0]}_ocr_output")
        ...
        if output_format == 'txt':
            ...
            output_file = output_file_base + ".json"
