To modify your `main_script.py` to prompt the user for a desired output format (e.g., `txt`, `csv`, `json`) and handle saving the converted document in the selected format, you can follow these steps:
