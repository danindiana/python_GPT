...
To refactor the provided script into the suggested modular structure, we need to break down the code into separate modules as outlined. Below is the refactored code for each module:
...
1. **Test Each Module**: Ensure each module works independently.
2. **Integrate Modules**: Update the main script to use the new modular imports and ensure each component integrates seamlessly.
3. **Refactor and Optimize**: Continuously refactor and optimize the code for better performance and maintainability.

If you need help with specific refactoring tasks or encounter any issues, feel free to ask!
