...
# Prompt the user to scan sub-folders recursively
recursive = input("Do you wish to scan and process sub-folders recursively? (Y/N): ").strip().lower() == 'y'
...
max_sequence_length = 41768  # Define the max sequence length

# Gather all PDF files, either recursively or only from the specified directory
pdf_files = []
